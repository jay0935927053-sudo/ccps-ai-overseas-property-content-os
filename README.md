...
5. 在「CCPS 信任內容來源庫」選擇搜尋主題，也可加上自訂關鍵字及來源篩選；找到資料後加入個人素材庫，再作為文章規劃依據。
...
- 首頁品牌與資訊架構：標題為「UHOS ccps自媒體工廠」，使用 Uncle House Logo；公司網站、廣告管理、快速工作平台及最近文章收進三條線功能目錄。首頁第一功能為「自媒體產生器」，下方提供「快速工作入口」。頁尾連結房叔 UHOS 著作權聲明與使用規則。
