...
export function buildArticle(form,recent=[]) {
  ...
  return {blocked:false,role:form.content_role,hook,body,comment_question:form.comment_question,image_suggestion:form.visual_type,checks,why_different:`與最近兩篇有 ${dna.differences}/5 個 Content DNA 欄位不同`,dna_status:dna.pass?"PASS":"FAIL: LOW_CONTENT_DNA_VARIANCE",...form};
}
